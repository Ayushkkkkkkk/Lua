...
require('lazy').setup {
  ...
  -- Declare the plugin with lazy loading
...
-- Map Ctrl+vx to ToggleTermToggleAll
...
vim.api.nvim_exec([[
  augroup cpp_mappings
    autocmd!
    autocmd FileType cpp nnoremap <buffer> <C-A-b> :w <bar> !g++ -std=c++14 % -o %:r<CR>
    autocmd FileType cpp nnoremap <buffer> <C-A-c> :execute '!start cmd /c ./' . fnameescape(expand('%:r'))<CR>
...
-- vim: ts=2 sts=2 sw=2 etinit.lua
